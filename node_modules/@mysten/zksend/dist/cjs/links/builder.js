...
const _ZkSendLinkBuilder = class {
  ...
  async createSendTransaction({
    ...
    if (!__privateGet(this, _contract)) {
      return __privateMethod(this, _createSendTransactionWithoutContract, createSendTransactionWithoutContract_fn).call(this, { transaction, calculateGas });
    }
  ...
  async createSendToAddressTransaction({
    ...
    const objectsToTransfer = (await __privateMethod(this, _objectsToTransfer, objectsToTransfer_fn).call(this, transaction)).map((obj) => obj.ref);
    transaction.setSenderIfNotSet(this.sender);
...
createSendTransactionWithoutContract_fn = async function({
  ...
  const objectsToTransfer = (await __privateMethod(this, _objectsToTransfer, objectsToTransfer_fn).call(this, tx)).map((obj) => obj.ref);
